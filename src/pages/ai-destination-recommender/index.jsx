...
const AIDestinationRecommender = () => {
  ...
  const generateRecommendations = async () => {
    ...
    try {
      ...
      [
        {
          ...
          "state": "Goa",
          "confidenceScore": 88,
          "aiExplanation": "Great choice for relaxation and beach activities! Goa's beaches, vibrant nightlife, and Portuguese heritage align well with your preferences. Easy to reach from ${startingPointLabel} with multiple flight and train options.",
          "costPerDay": 3000,
          ...
          "bestMonths": "Nov-Mar",
          "highlights": ["Pristine beaches and water sports", "Portuguese colonial architecture", "Vibrant nightlife and beach shacks", "Spice plantations tour", "Dudhsagar waterfalls", "Local seafood cuisine"],
          "matchingStyles": ["Relaxation", "Food & Cuisine", "Cultural"]
        }
      ]`;
      
      // Call Gemini API with correct endpoint
      const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyB6JqlnZfDBqdkHj9bTZWob6ZX2Jxxfl1g`, {
        method: 'POST',
        headers: {
      ...
      // Handle the response structure from Gemini
